...
import ds.imagestyling.custom.filter.IF1977Filter;
import ds.imagestyling.custom.filter.IFAmaroFilter;
import ds.imagestyling.custom.filter.IFBrannanFilter;
import ds.imagestyling.custom.filter.IFEarlybirdFilter;
import ds.imagestyling.custom.filter.IFHefeFilter;
import ds.imagestyling.custom.filter.IFHudsonFilter;
import ds.imagestyling.custom.filter.IFInkwellFilter;
import ds.imagestyling.custom.filter.IFLomoFilter;
import ds.imagestyling.custom.filter.IFLordKelvinFilter;
import ds.imagestyling.custom.filter.IFNashvilleFilter;
import ds.imagestyling.custom.filter.IFRiseFilter;
import ds.imagestyling.custom.filter.IFSierraFilter;
import ds.imagestyling.custom.filter.IFSutroFilter;
import ds.imagestyling.custom.filter.IFToasterFilter;
import ds.imagestyling.custom.filter.IFValenciaFilter;
import ds.imagestyling.custom.filter.IFWaldenFilter;
import ds.imagestyling.custom.filter.IFXprollFilter;
import ds.imagestyling.custom.filter.NormalFilter;
...
public class GPUImageFilterTools {
    private static FilterList filters=null;
    public static void showDialog(final Context context,int position,
...
//
        ...
        listener.onGpuImageFilterChosenListener(
                createFilterForType(context, filters.filters.get(position)));
...
public static List<FilterType> getFiletList()
{
    return filters.filters;
}public static void setFilterList()
{
    filters = new FilterList();
